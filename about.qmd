---
title: "About Me"
subtitle: "Learn about my professional interests and experience."
image: bg-pinecone.jpg

keywords: about, about me
---

![A snapshot of my wildlife work.](img-ben-work.png)
...
leaflet() %>%
  ...
  addMarkers(lng=-92.286, lat=38.890) %>% 
  setView(lng=-92.286, lat=38.890, zoom = 10)
```


## Photos
::: {layout="[[1, 1], [1]]"}
![A Lovely Image](bg-pinecone.jpg){group="my-gallery"}

![Another Lovely Image](img-computer.png){group="my-gallery"}

![The Last Lovely Image](img-data-viz.jpg){group="my-gallery"}
:::
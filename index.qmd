  ...
  - id: site-listings-2
    contents:
      - title: "*Latest Post:* <br> Create Annotated Bibliographies with Quarto"
        path: posts/building-annotated-bibliographies-with-quarto/
      - title: "*Latest Visual:* <br> Anthrome Map of the Upper Peninsula, MI"
        path: gallery/michigan-anthrome-map/
    type: grid
    grid-columns: 2
    grid-item-align: center
    fields:

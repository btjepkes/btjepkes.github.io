...
data <- data.frame(
  C1 = c("Cartographic Design",
           ...
           "Data Management",
           "Project Management"),
  C2 = c("Adept as using R, ArcGIS Pro, and ArcGIS Online to create static and dynamic maps, with a comprehensive understanding of cartographic design fundamentals.",

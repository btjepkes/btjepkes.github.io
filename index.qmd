...
[About My Career](about.qmd){.btn-action-primary  .btn-action .btn .btn-success .btn-lg role="button" style="margin-top: 1em;"} [My Resume {{< fa arrow-right size=1.5x >}}](cv.qmd){.btn-action-secondary  .btn-action .btn .btn-success-alt-2 .btn-lg role="button" style="margin-top: 1em;"}
...
#### Artfully-Precise {.index-h4}
## Posts & Writings {.index-h2}

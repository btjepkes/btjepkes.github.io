...
I am currently a graduate student at the University of Missouri studying geographic information systems (GIS) and geography. I possess more than seven years of continuous professional development with governmental, private, and academic entities in the environmental sector. My work focuses on using a variety of data science and geospatial technologies to research the natural world, specifically for wildlife conservation.
:::

::: {.index-intro-start-icons}

[{{< fa brands linkedin size=3x >}}](https://www.linkedin.com/in/benjamintjepkes/) [{{< fa brands github size=3x >}}](https://github.com/btjepkes) [{{< fa brands twitter size=3x >}}](https://twitter.com/BTjepkes) [{{< fa brands researchgate size=3x >}}](https://www.researchgate.net/profile/Benjamin-Tjepkes)
:::

...
image: "assets/img-bog-trees.jpg"
...
{{< fa layer-group size=4x >}}

**Geospatial & Cartography**

<!-- Spatial data creation, management, and analysis using desktop, web, and mobile GIS software. Static and dynamic cartographic design using QGIS and ArcGIS mapping software. Geoprocessing workflows in ArcGIS ModelBuilder and Jupyter Notebooks. -->

:::
    
:::{.col-sm}

{{< fa chart-simple size=4x >}}

**Research & Reporting**

<!-- Data entry, management, and analysis using Program R, Microsoft Excel, Access, and SQL Server. Reproducible report design and development in Microsoft Word, R Markdown, and Quarto. Knowledge of scientific methods and research project development. -->
    
:::
:::{.col-sm}

{{< fa file-code size=4x >}}

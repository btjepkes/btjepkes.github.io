...
# date-modified: today
author: ""
description: "This page provides detailed overview of my formal education, recent professional experience, and professional skillset. Please also check out my full CV for a comprehensive listing of conference presentations, professional involvement, and technical publications or my 1-page Resume for a shorter version. My profile on [LinkedIn](https://www.linkedin.com/in/benjamintjepkes/) also provides information."
toc: false
format:
  html:
    echo: false
...
### View PDF versions here: {.centered .unnumbered .unlisted}
...
leaflet(sites, options = leafletOptions(minZoom = 5, maxZoom = 7)) |> 

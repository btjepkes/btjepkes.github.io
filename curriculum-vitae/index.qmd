...
# date-modified: today
author: ""
description: "This page provides detailed overview of my formal education, recent professional experience, and professional skillset. Please also check out my [full CV](Tjepkes_CV_20231030_Web.pdf) for a comprehensive listing of conference presentations, professional involvement, and technical publications. My profile on [LinkedIn](https://www.linkedin.com/in/benjamintjepkes/) provides additional information as well."
format:
  html:
    echo: false
    warning: false
...
![](../assets/johannes-plenio-Enhs8UrXEb0-unsplash.jpg){.cover-image}

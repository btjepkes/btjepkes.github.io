...
abstract: "Visualizing which U.S. states have more colleges"
date: 11/09/2023
date-modified: today
categories:
  - Map Gallery
...
![](img-college-map.png){.cover-image}

## Task & Objectives

The prompt for this map was for **Day Nine** of the 2023 [30 Day Map Challenge](https://30daymapchallenge.com/), which designated "Hexagons" for the main subject. The resulting map shows 51 hexbins, one for each state and Washington DC, where the color signifies the number of institutions in that state. 

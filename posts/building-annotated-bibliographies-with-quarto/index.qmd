---
title: "Annotated Bibliographies with Quarto in R"
date: 2024-01-01
date-modified: today
abstract: "Streamlining your bibliography creation using Quarto and Zotero in R"
...
I suggest using these options are because they are **both free**, they have **native integration**, and are **highly flexible**. This process allows for greater flexibility than other software, like rendering into HTML, PDF, or Word formats independently or all at once. I prefer multi-format rendering so I can send them all out in a zipped folder and the recipient can choose whichever works best for them.
...
### Add Citations and Summary Notes
...
After you insert the proper citation, the next part is a chunk of executable R code. This is the meat and potatoes of the whole operation. This chunk will need to be copy-pasted after each citation key you want to use. Then you will need to copy the citation key and paste it into whichever chunk follows it.

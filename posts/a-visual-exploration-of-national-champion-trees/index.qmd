---
title: A Visual Exploration of Champion Trees
subtitle: Charting trees from the US National Champion Tree Network.
date-modified: today
date: 12/19/2023
draft: TRUE
image: "../../assets/bg-pine-blue.jpg"
description: "In this post, I start exploring our towering timber giants apart of the National Champion Trees Program as designated by American Forests."
---
...
The map below displays the locations of each of the champion trees on the register. As noted, there are **over 500 individuals** on this list. Details on this map can be found [here](../../gallery/national-champion-tree-map/index.qmd).

![Map of Champion Tree locations across the United States. Credit: Benjamin Tjepkes](../../gallery/national-champion-tree-map/img-national-champion-trees.png)
...
Great, that's get to it. First things first, we need to get our data loaded into R and cleaned for our use.

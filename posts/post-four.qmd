...
- Querying species occurrence data from the GBIF API using `rgbif` within the RStudio environment.
- Using the `leaflet` package to make interactive maps, including an adaptive heatmap. 
